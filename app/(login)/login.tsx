    ...
    <div className="min-h-[100dvh] flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gray-50">
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <form className="space-y-6" action={mode === 'signin' ? signIn : signUp}>
          ...
          <div>
            <Button type="submit" className="w-full flex justify-center items-center py-2 px-4 rounded-full text-sm font-medium text-white bg-orange-600">
              {/* No client pending state here; keep it simple for server component */}
        ...
        <div className="mt-6">
          ...
          <div className="mt-6">
            <Link
              ...
              className="w-full flex justify-center py-2 px-4 border rounded-full text-sm font-medium text-gray-700 bg-white hover:bg-gray-50"
            >
